...
########################## THEMING  #######################
# Enable comprehensive theming to use custom themes
ENABLE_COMPREHENSIVE_THEMING = True

# Add the themes directory to the comprehensive theme directories
COMPREHENSIVE_THEME_DIRS = [
    str(REPO_ROOT / "themes")
]

# Import the make_mako_template_dirs method to set up template directories
from openedx.envs.common import make_mako_template_dirs
TEMPLATES[1]["DIRS"] = make_mako_template_dirs

# Set the default theme to your custom theme
DEFAULT_SITE_THEME = "custom-theme"

########################## CUSTOM FOOTER SETTINGS #######################
# Override the default footer settings to remove Open edX branding
